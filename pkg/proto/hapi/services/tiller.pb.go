...
type InstallReleaseRequest struct {
	...
	ReuseName bool `protobuf:"varint,7,opt,name=reuse_name,json=reuseName" json:"reuse_name,omitempty"` //重用指定的名,即使指定的名字已经存在.不能重用正在使用,但能够重用已删除的.
	// timeout specifies the max amount of time any kubernetes client command can run.
...
//请求/pkg/tiller/release_install.go中的InstallRelease
